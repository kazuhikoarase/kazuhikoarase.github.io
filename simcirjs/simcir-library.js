...
simcir.registerDevice('T-FF',
{
  ...
  "devices":[
    {"type":"JK-FF","id":"dev0","x":80,"y":32,"label":"JK-FF"},
    {"type":"In","id":"dev1","x":16,"y":16,"label":"T"},
    {"type":"In","id":"dev2","x":16,"y":64,"label":"CLK"},
    {"type":"Out","id":"dev3","x":176,"y":16,"label":"Q"},
    {"type":"Out","id":"dev4","x":176,"y":64,"label":"~Q"}
  ],
  "connectors":[
    {"from":"dev0.0","to":"dev1.1"},
    {"from":"dev0.1","to":"dev2.1"},
    {"from":"dev0.2","to":"dev1.1"},
    {"from":"dev3.0","to":"dev0.3"},
    {"from":"dev4.0","to":"dev0.4"}
  ]
}
);
